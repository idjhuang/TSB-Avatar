        ...
        if (event.track.kind === 'video') {
            ...
            */
            ...
            mediaPlayer.addEventListener('play', () => {
                ...
                */
                remoteVideoDiv.style.width = '640px' // mediaPlayer.videoWidth / 2 + 'px'
...
window.startSession = (key) => {
    Event.flag = false
    const cogSvcRegion = 'southeastasia'
    const cogSvcSubKey = key //'e7dc91ac0b9c46ea880135bca1c5b145'
    if (cogSvcSubKey === '' || cogSvcSubKey === null) {
...
window.speak = (text) => {
    ...
    let spokenText = text
    let ttsVoice = 'zh-TW-HsiaoChenNeural'
